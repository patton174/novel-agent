...
from app.agent_step.subagent import build_subagent_context, subagent_depth
from app.agent_step.subagent_policy import is_subagent_run
from app.agent_step.tools.cc.schemas import AgentInput
...
def _subagent_tool_meta(payload: dict[str, Any], tool: str) -> dict[str, Any]:
    ...
    from app.agent_step.events import _tool_input_for_sse
    from app.agent_step.tool_ui import vfs_path_from_tool_input
...
async def stream_subagent_tool(
    ...
    *,
    ...
    from app.agent_step.cc_visibility import tool_display_name
