...
from app.agent_step.vfs.format import FILE_UNCHANGED_STUB
...
def extract_memory_read_labels_from_text(content: str) -> list[str]:
    from app.agent_step.events import extract_memory_read_labels
...
def default_ui_excerpt_registry() -> dict[str, UiExcerptFn]:
    write = lambda c, i: write_edit_ui_excerpt(c, {**i, "_tool": "Write"})
    edit = lambda c, i: write_edit_ui_excerpt(c, {**i, "_tool": "Edit"})
    return {
        "Read": read_ui_excerpt,
        "memory_read": read_ui_excerpt,
        "Glob": glob_ui_excerpt,
        "Grep": grep_ui_excerpt,
        "context_search": grep_ui_excerpt,
        "Write": write,
        "Edit": edit,
        "Delete": delete_ui_excerpt,
        "TodoWrite": todo_write_ui_excerpt,
        "AskUser": ask_user_ui_excerpt,
        "ReorderChapters": reorder_chapters_ui_excerpt,
        "ToolSearch": tool_search_ui_excerpt,
        "EnterPlanMode": plan_mode_ui_excerpt,
        "ExitPlanMode": plan_mode_ui_excerpt,
        "Brief": brief_ui_excerpt,
        "Skill": skill_ui_excerpt,
        "Agent": agent_ui_excerpt,
        "TaskCreate": task_ui_excerpt,
        "TaskGet": task_ui_excerpt,
        "TaskList": task_ui_excerpt,
        "TaskUpdate": task_ui_excerpt,
        "TaskStop": task_ui_excerpt,
        "WebFetch": web_stub_ui_excerpt,
        "WebSearch": web_stub_ui_excerpt,
        "NotebookEdit": generic_ui_excerpt,
