...
from app.agent_step.prompting.blocks import coerce_text_snippet, join_human_blocks, json_block
...
from app.agent_step.prompting.run_context import format_run_context_block
from app.agent_step.prompting.tool_contracts import (
    STEP_SUBMIT_SYSTEM,
...
def build_output_stream_messages(
    ...
    from app.agent_step.prompting.output_input import normalize_output_input
