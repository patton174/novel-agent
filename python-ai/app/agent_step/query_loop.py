...
from app.agent_step.context_compact_autocompact import autocompact_conversation
from app.agent_step.context_compact_micro import microcompact_messages
from app.agent_step.context_meter import measure_agent_context
...
from app.agent_step.context_compact import apply_chapter_tool_patch_to_ctx
from app.agent_step.context_enrich import (
...
from app.agent_step.subagent import build_subagent_run_context_human, build_subagent_system_prompt
from app.agent_step.subagent_policy import is_subagent_run
...
from app.agent_step.tool_batch_errors import (
...
from app.agent_step.tool_errors import format_input_validation_error
from app.agent_step.query_loop_support import (
    _MAX_LLM_PAIRING_RETRIES_PER_TURN,
    _MAX_TOOL_RECOVERIES_PER_TURN,
    _MAX_VALIDATION_RETRIES_PER_TURN,
)
from app.agent_step.tool_orchestration import execute_tool_batches, partition_tool_calls
...
async def run_query_loop(req: RunRequest) -> AsyncIterator[dict[str, Any]]:
    ...
    try:
        while state.turn < turn_limit and not state.terminal:
            ...
            if not ai_calls:
                from app.agent_step.events import assistant_message_events
