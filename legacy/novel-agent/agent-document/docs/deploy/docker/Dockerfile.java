...
RUN mvn -f novel-agent/pom.xml \
  -pl agent-service/agent-auth,agent-service/agent-gateway,agent-service/agent-pyai,agent-service/agent-content,agent-service/agent-consumer,agent-service/agent-billing \
