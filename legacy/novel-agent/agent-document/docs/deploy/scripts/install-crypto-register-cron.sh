...
CRON_LINE="0 3 * * * cd $REMOTE_DIR && bash $REMOTE_DIR/legacy/novel-agent/agent-document/docs/deploy/scripts/register-frontend-crypto.sh >> /var/log/crypto-register.log 2>&1"
