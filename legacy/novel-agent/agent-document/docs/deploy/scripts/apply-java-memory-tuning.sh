...
apply_worker() {
  ...
  deploy_ssh "$WK" "chmod +x '$DIR/legacy/novel-agent/agent-document/docs/deploy/scripts/worker-apply-infra.sh' && DEPLOY_DIR='$DIR' bash '$DIR/legacy/novel-agent/agent-document/docs/deploy/scripts/worker-apply-infra.sh'"
...
ENV=legacy/novel-agent/agent-document/docs/deploy/docker/.env.worker
...
apply_mw() {
  ...
  deploy_ssh "$MW" "mkdir -p '$DIR/legacy/novel-agent/agent-document/docs/deploy/docker'"
  deploy_scp "$DOCKER_DIR/docker-compose.mw.yml" "$MW:$DIR/legacy/novel-agent/agent-document/docs/deploy/docker/docker-compose.mw.yml"
...
ENV=legacy/novel-agent/agent-document/docs/deploy/docker/.env.mw
