...
#
#   bash legacy/novel-agent/agent-document/docs/deploy/scripts/setup-deploy-config.sh
set -euo pipefail
...
echo "  3. 一键部署: bash legacy/novel-agent/agent-document/docs/deploy/scripts/deploy-remote.sh"
echo ""
