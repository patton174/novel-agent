...
#
#   bash legacy/novel-agent/agent-document/docs/deploy/scripts/apply-mw-jwt-env.sh
#
set -euo pipefail
...
deploy_scp "$REPO_ROOT/legacy/novel-agent/agent-document/docs/deploy/docker/docker-compose.mw.yml" \
  "$MW_SSH:$REMOTE_DIR/$COMPOSE_FILE"
deploy_scp "$REPO_ROOT/legacy/novel-agent/agent-document/docs/deploy/docker/nacos-split/agent-auth.yaml" \
  "$MW_SSH:$REMOTE_DIR/legacy/novel-agent/agent-document/docs/deploy/docker/nacos-split/agent-auth.yaml"
deploy_scp "$REPO_ROOT/legacy/novel-agent/agent-document/docs/deploy/docker/nacos-split/agent-gateway.yaml" \
  "$MW_SSH:$REMOTE_DIR/legacy/novel-agent/agent-document/docs/deploy/docker/nacos-split/agent-gateway.yaml"
