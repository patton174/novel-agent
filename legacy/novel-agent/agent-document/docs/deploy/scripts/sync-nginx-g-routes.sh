...
deploy_scp "$DEPLOY_DIR/nginx-frontend-worker.conf" \
  "$WORKER_SSH:$WORKER_DIR/legacy/novel-agent/agent-document/docs/deploy/docker/nginx-frontend-worker.conf"
...
docker cp "legacy/novel-agent/agent-document/docs/deploy/docker/nginx-frontend-worker.conf" "\$CID:/etc/nginx/conf.d/default.conf"
