...
#
#   bash legacy/novel-agent/agent-document/docs/deploy/scripts/recover-mw-stack.sh
#   REBUILD=1 bash legacy/novel-agent/agent-document/docs/deploy/scripts/recover-mw-stack.sh
#
set -euo pipefail
