...
DOCKER_MW="$MW_DIR/legacy/novel-agent/agent-document/docs/deploy/docker"
DOCKER_WK="$WK_DIR/legacy/novel-agent/agent-document/docs/deploy/docker"
TOTAL=9
...
step7_hot_jars() {
  deploy_ssh "$MW_SSH" bash -s <<'REMOTE'
set -eu
CF=/opt/novel-agent/legacy/novel-agent/agent-document/docs/deploy/docker/docker-compose.mw.yml
ENV=/opt/novel-agent/legacy/novel-agent/agent-document/docs/deploy/docker/.env.mw
hot() {
