...
LOCAL_JAR="${LOCAL_JAR:-$REPO_ROOT/novel-agent/agent-service/$MODULE/target/$JAR_NAME}"
...
if [[ "$SERVICE" == "auth" ]]; then
  bash "$REPO_ROOT/novel-agent/agent-document/docs/deploy/scripts/register-auth-secrets.sh" || true
fi
