...
#
#   bash novel-agent/agent-document/docs/deploy/scripts/deploy-route-v2.sh auth
#   bash novel-agent/agent-document/docs/deploy/scripts/deploy-route-v2.sh gateway
#   bash novel-agent/agent-document/docs/deploy/scripts/deploy-route-v2.sh frontend
#   bash novel-agent/agent-document/docs/deploy/scripts/deploy-route-v2.sh register
#   bash novel-agent/agent-document/docs/deploy/scripts/deploy-route-v2.sh all
#
# nginx /g/ 需一次性手动配置，见 novel-agent/agent-document/docs/deploy/scripts/patch-nginx-g-location.sh
#
set -euo pipefail
