...
upsert JAVA_OPTS_AUTH "-Xms64m -Xmx160m -XX:MaxMetaspaceSize=96m -XX:+UseSerialGC -XX:TieredStopAtLevel=1 -XX:+ExitOnOutOfMemoryError -Dfile.encoding=UTF-8"
...
upsert JAVA_MEM_LIMIT_AUTH "320m"
