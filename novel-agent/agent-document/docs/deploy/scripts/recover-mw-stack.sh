...
#
#   bash novel-agent/agent-document/docs/deploy/scripts/recover-mw-stack.sh
#   REBUILD=1 bash novel-agent/agent-document/docs/deploy/scripts/recover-mw-stack.sh
#
set -euo pipefail
