...
SPRING_PROFILES_ACTIVE=${SPRING_PROFILES_ACTIVE:-dev}
PYTHON_LOG_LEVEL=${PYTHON_LOG_LEVEL:-INFO}
JAVA_OPTS_CONTENT=${JAVA_OPTS_CONTENT:--Xms96m -Xmx240m -XX:MaxMetaspaceSize=144m -Dfile.encoding=UTF-8}
JAVA_OPTS_PYAI=${JAVA_OPTS_PYAI:--Xms64m -Xmx176m -XX:MaxMetaspaceSize=96m -XX:+UseSerialGC -Dfile.encoding=UTF-8}
JAVA_OPTS_CONSUMER=${JAVA_OPTS_CONSUMER:--Xms64m -Xmx152m -XX:MaxMetaspaceSize=80m -XX:+UseSerialGC -Dfile.encoding=UTF-8}
PYTHON_MEM_LIMIT=${PYTHON_MEM_LIMIT:-448m}
PYTHON_MEM_LIMIT_2=${PYTHON_MEM_LIMIT_2:-384m}
JAVA_MEM_LIMIT_CONTENT=${JAVA_MEM_LIMIT_CONTENT:-384m}
JAVA_MEM_LIMIT_PYAI=${JAVA_MEM_LIMIT_PYAI:-256m}
JAVA_MEM_LIMIT_CONSUMER=${JAVA_MEM_LIMIT_CONSUMER:-224m}
JAVA_MEM_LIMIT_BILLING=${JAVA_MEM_LIMIT_BILLING:-448m}
JAVA_OPTS_BILLING=${JAVA_OPTS_BILLING:--Xms64m -Xmx220m -XX:MaxMetaspaceSize=128m -Dfile.encoding=UTF-8}
