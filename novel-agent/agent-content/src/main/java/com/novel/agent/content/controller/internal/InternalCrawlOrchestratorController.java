...
import com.novel.agent.content.service.crawl.dto.InternalCreateCrawlJobRequest;
...
public class InternalCrawlOrchestratorController {
    ...
    public com.novel.agent.common.core.base.Page<CrawlJobDTO> pageJobs(
        @RequestParam(defaultValue = "1") int pageCurrent,
        @RequestParam(defaultValue = "20") int pageSize
    ) {
        var page = crawlJobService.pageJobs(pageCurrent, pageSize);
        return com.novel.agent.common.core.base.Page.of(
