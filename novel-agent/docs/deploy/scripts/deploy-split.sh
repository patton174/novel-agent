...
#   bash novel-agent/docs/deploy/scripts/deploy-split.sh
set -euo pipefail
...
COMPOSE_MW="novel-agent/docs/deploy/docker/docker-compose.mw.yml"
COMPOSE_WORKER="novel-agent/docs/deploy/docker/docker-compose.worker.yml"
ENV_MW_REL="novel-agent/docs/deploy/docker/.env.mw"
ENV_WORKER_REL="novel-agent/docs/deploy/docker/.env.worker"
...
deploy_scp_file "$DEPLOY_DIR/nginx-frontend-worker.conf" "$WORKER_SSH" "$WORKER_DIR/novel-agent/docs/deploy/docker/nginx-frontend-worker.conf"
...
deploy_scp_file "$DEPLOY_DIR/nginx-python-lb.conf" "$MW_SSH" "$MW_DIR/novel-agent/docs/deploy/docker/nginx-python-lb.conf"
deploy_scp_file "$DEPLOY_DIR/nginx-entry-mw.conf" "$MW_SSH" "$MW_DIR/novel-agent/docs/deploy/docker/nginx-entry-mw.conf"
