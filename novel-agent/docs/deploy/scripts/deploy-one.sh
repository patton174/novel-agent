...
# 日常改代码请用：bash novel-agent/docs/deploy/scripts/deploy-fast.sh gateway mw
#
#   bash novel-agent/docs/deploy/scripts/deploy-one.sh [service] [host]
# 例: bash novel-agent/docs/deploy/scripts/deploy-one.sh agent-auth mw
