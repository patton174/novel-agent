...
PYTHON_MEM_LIMIT=${PYTHON_MEM_LIMIT:-320m}
PYTHON_MEM_LIMIT_2=${PYTHON_MEM_LIMIT_2:-320m}
JAVA_MEM_LIMIT=${JAVA_MEM_LIMIT:-288m}
SPRING_DATASOURCE_URL=jdbc:postgresql://${MW_HOST}:5432/novel_agent?sslmode=disable
SPRING_DATASOURCE_USERNAME=postgres
...
AGENT_PYTHON_BASE_URL=http://${MW_HOST}:8000
...
echo "Python 流量: Java → ${MW_HOST}:8000 (nginx LB) → Worker :8000/:8001 双实例"
echo ""
