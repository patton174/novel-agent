...
SPRING_PROFILES_ACTIVE=${SPRING_PROFILES_ACTIVE:-dev}
PYTHON_LOG_LEVEL=${PYTHON_LOG_LEVEL:-INFO}
JAVA_OPTS_CONTENT=${JAVA_OPTS_CONTENT:--Xms64m -Xmx200m -XX:MaxMetaspaceSize=96m -XX:+UseSerialGC -Dfile.encoding=UTF-8}
...
JAVA_MEM_LIMIT_CONTENT=${JAVA_MEM_LIMIT_CONTENT:-320m}
