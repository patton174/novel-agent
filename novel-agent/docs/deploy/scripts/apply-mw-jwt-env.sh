...
#
#   bash novel-agent/docs/deploy/scripts/apply-mw-jwt-env.sh
#
set -euo pipefail
...
deploy_scp "$REPO_ROOT/novel-agent/docs/deploy/docker/nacos-split/agent-auth.yaml" \
  "$MW_SSH:$REMOTE_DIR/novel-agent/docs/deploy/docker/nacos-split/agent-auth.yaml"
deploy_scp "$REPO_ROOT/novel-agent/docs/deploy/docker/nacos-split/agent-gateway.yaml" \
  "$MW_SSH:$REMOTE_DIR/novel-agent/docs/deploy/docker/nacos-split/agent-gateway.yaml"
