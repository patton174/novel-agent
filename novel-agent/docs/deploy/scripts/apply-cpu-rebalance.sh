...
DIR=/opt/novel-agent
CF_MW=$DIR/novel-agent/docs/deploy/docker/docker-compose.mw.yml
CF_WK=$DIR/novel-agent/docs/deploy/docker/docker-compose.worker.yml
ENV_MW=$DIR/novel-agent/docs/deploy/docker/.env.mw
ENV_WK=$DIR/novel-agent/docs/deploy/docker/.env.worker
NGINX=$DIR/novel-agent/docs/deploy/docker/nginx-python-lb.conf
