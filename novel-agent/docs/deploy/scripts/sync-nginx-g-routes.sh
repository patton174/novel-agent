...
DOCKER_DIR="$MW_DIR/novel-agent/docs/deploy/docker"
...
deploy_scp "$DEPLOY_DIR/nginx-frontend-worker.conf" \
  "$WORKER_SSH:$WORKER_DIR/novel-agent/docs/deploy/docker/nginx-frontend-worker.conf"
...
docker cp "novel-agent/docs/deploy/docker/nginx-frontend-worker.conf" "\$CID:/etc/nginx/conf.d/default.conf"
