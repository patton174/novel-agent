...
stop_on "MW" "$MW_SSH" "$MW_DIR" \
  "novel-agent/docs/deploy/docker/docker-compose.mw.yml" \
  "novel-agent/docs/deploy/docker/.env.mw"

stop_on "Worker" "$WORKER_SSH" "$WORKER_DIR" \
  "novel-agent/docs/deploy/docker/docker-compose.worker.yml" \
  "novel-agent/docs/deploy/docker/.env.worker"
