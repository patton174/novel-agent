// Icon metadata for search and categorization (from cc-switch)

export interface CcSwitchIconMetadata {
  name: string
  displayName: string
  category: string
  keywords: string[]
...
export const iconMetadata: Record<string, CcSwitchIconMetadata> = {
  aigocode: {
    name: "aigocode",
...
export function getIconMetadata(name: string): CcSwitchIconMetadata | undefined {
