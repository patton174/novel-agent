            ...
            {steps.map((n, index) => {
              ...
              return (
                <motion.li
                  ...
                  className="mkt-card-lift scroll-mt-24 rounded-2xl border border-border/70 bg-white/90 p-6 shadow-[0_8px_32px_-12px_rgba(79,70,229,0.1)] backdrop-blur-sm md:p-8"
                >
