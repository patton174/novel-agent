    ...
    <MarketingPageLayout>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:py-20">
        ...
        <div className="mt-10 flex flex-wrap gap-3 border-t border-border/60 pt-10">
          <Link
            to="/pricing"
            className="inline-flex items-center gap-2 rounded-full border border-border bg-white/80 px-6 py-2.5 text-sm font-semibold text-foreground shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"
          >
            {t('nav.pricing')}
          </Link>
          <Link
            to="/register"
            className="mkt-cta-glow inline-flex items-center gap-2 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground transition hover:-translate-y-0.5 hover:bg-primary-hover"
          >
            {t('nav.register')}
