package cn.novelstudio.module.upload.controller.auth;

import cn.novelstudio.kernel.base.Page;
import cn.novelstudio.kernel.base.Result;
import cn.novelstudio.module.upload.dto.UploadFileDTO;
import cn.novelstudio.module.upload.service.auth.AuthUploadBiz;
...
/** 用户上传端点：/api/content/auth/upload/*（路径保持不变，模块已解耦）。 */
@RestController
